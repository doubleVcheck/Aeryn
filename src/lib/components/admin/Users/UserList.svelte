...
> 
> ZaneLLM is completely free to use as-is, with no restrictions or hidden limits, and we'd love to keep it that way. 🌱
>
...
> 
> - 👉 **[Click here to learn more about enterprise licensing](https://zanellm.ai/docs/enterprise)**
> - 👉 *[Click here to sponsor the project on GitHub](https://github.com/sponsors/zephyrzane)*
`}
			/>
		</div>
	{/if}
