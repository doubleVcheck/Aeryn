...
# can't be a legitimate ZaneLLM collection name.
...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current ZaneLLM naming conventions for
        collection names. If ZaneLLM changes how it generates collection names
