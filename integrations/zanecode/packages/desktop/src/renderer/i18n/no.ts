export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av zanecode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av zanecode er lastet ned. Vil du installere den og starte på nytt?",
