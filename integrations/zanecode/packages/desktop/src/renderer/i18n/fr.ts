export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'zanecode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'zanecode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
