export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju zanecode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} zanecode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
