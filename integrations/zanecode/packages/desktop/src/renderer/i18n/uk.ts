export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію zanecode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} zanecode завантажено. Бажаєте встановити її та перезапустити?",
