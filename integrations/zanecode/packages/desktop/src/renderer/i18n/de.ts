export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von zanecode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von zanecode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
