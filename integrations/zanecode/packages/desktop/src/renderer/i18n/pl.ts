export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji zanecode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} zanecode. Czy chcesz ją zainstalować i uruchomić ponownie?",
