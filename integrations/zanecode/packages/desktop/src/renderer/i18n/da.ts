export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af zanecode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af zanecode er blevet downloadet. Vil du installere den og genstarte?",
