...
description: zanecode, LSP sunucularınızla bütünleşir.
---

zanecode, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

zanecode, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
