---
title: Zen
description: Lista seleccionada de modelos proporcionada por zanecode.
---
...
zanecode Zen es una lista de modelos probados y verificados proporcionada por el equipo de zanecode.

Zen funciona como cualquier otro proveedor en zanecode. Inicias sesión en zanecode Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con zanecode.
:::
...
zanecode Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

zanecode Zen funciona como cualquier otro proveedor en zanecode.

1. Inicias sesión en **<a href={console}>zanecode Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas zanecode Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de zanecode
...
- DeepSeek V4 Flash Free está disponible en zanecode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en zanecode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- North Mini Code Free está disponible en zanecode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en zanecode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en zanecode por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con zanecode.
