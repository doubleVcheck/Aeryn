...
Las habilidades del agente permiten a zanecode descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
zanecode busca estas ubicaciones:
...
Para las rutas locales del proyecto, zanecode sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
zanecode enumera las habilidades disponibles en la descripción de la herramienta `skill`.
