...
description: zanecode se integra con sus servidores LSP.
---

zanecode puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

zanecode viene con varios servidores LSP integrados para idiomas populares:
