---
title: Compartir
description: Comparte tus conversaciones zanecode.
---

La función para compartir de zanecode te permite crear enlaces públicos a tus conversaciones de zanecode, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, zanecode:
...
zanecode admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, zanecode usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
