...
Puede agregar comandos personalizados a través de la configuración zanecode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su zanecode [config](/docs/config):
