---
title: TUI
description: Usando la interfaz de usuario del terminal zanecode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

zanecode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar zanecode se inicia TUI para el directorio actual.
...
Cuando utilice zanecode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a zanecode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de zanecode. _Alias_: `/quit`, `/q`
...
- `leader_timeout`: controla cuánto tiempo espera zanecode después de la leader key. El valor predeterminado es `2000`.
