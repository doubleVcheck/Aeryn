---
title: Dodaci
description: Napišite vlastite dodatke za proširenje zanecode.
---

Dodaci vam omogućavaju da proširite zanecode spajanjem na različite događaje i prilagođavanjem ponašanja. Možete kreirati dodatke za dodavanje novih funkcija, integraciju sa eksternim uslugama ili izmenu zadanog ponašanja zanecode.
...
zanecode pokreće `bun install` pri pokretanju da ih instalira. Vaši dodaci i alati ih zatim mogu uvesti.
...
Evo nekoliko primjera dodataka koje možete koristiti za proširenje zanecode.
