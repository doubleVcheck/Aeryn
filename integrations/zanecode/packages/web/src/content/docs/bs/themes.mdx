...
U zanecode mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, zanecode koristi nasu `opencode` temu.
...
zanecode dolazi sa vise ugradenih tema.
...
- Zele da zanecode odgovara izgledu njihovog terminala
...
zanecode podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
