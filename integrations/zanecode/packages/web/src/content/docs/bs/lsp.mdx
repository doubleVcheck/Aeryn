---
title: LSP serveri
description: zanecode se integriše sa vašim LSP serverima.
---

zanecode se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

zanecode dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
