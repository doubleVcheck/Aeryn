---
title: TUI
description: Korištenje korisničkog interfejsa zanecode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

zanecode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje zanecode pokreće TUI za trenutni direktorij.
...
Kada koristite zanecode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u zanecode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz zanecode. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo zanecode čeka nakon leader key. Podrazumijevano je `2000`.
