...
Agent skills omogucavaju zanecode da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
zanecode pretrazuje ove lokacije:
...
Za projektne lokalne putanje, zanecode ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
zanecode navodi dostupne skills u opisu `skill` alata.
