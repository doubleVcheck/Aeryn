...
Le skill degli agenti permettono a zanecode di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
zanecode cerca in queste posizioni:
...
Per i percorsi locali al progetto, zanecode risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
zanecode elenca le skill disponibili nella descrizione dello strumento `skill`.
