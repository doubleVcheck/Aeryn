---
title: Zen
description: Lista curata di modelli fornita da zanecode.
---
...
zanecode Zen è un elenco di modelli testati e verificati forniti dal team di zanecode.

Zen funziona come qualsiasi altro provider in zanecode. Accedi a zanecode Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con zanecode.
:::
...
zanecode Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

zanecode Zen funziona come qualsiasi altro provider in zanecode.

1. Accedi a **<a href={console}>zanecode Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona zanecode Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di zanecode
...
- DeepSeek V4 Flash Free è disponibile su zanecode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su zanecode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su zanecode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su zanecode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su zanecode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato zanecode Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con zanecode.
