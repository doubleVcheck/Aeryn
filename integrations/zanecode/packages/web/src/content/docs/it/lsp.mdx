---
title: Server LSP
description: zanecode si integra con i tuoi server LSP.
---

zanecode può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

zanecode include diversi server LSP integrati per linguaggi popolari:
