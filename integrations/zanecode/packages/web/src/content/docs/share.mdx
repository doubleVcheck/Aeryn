---
title: Share
description: Share your zanecode conversations.
---

zanecode's share feature allows you to create public links to your zanecode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, zanecode:
...
zanecode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, zanecode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
