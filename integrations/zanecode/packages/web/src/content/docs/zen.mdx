---
title: Zen
description: Curated list of models provided by zanecode.
---
...
zanecode Zen is a list of tested and verified models provided by the zanecode team.

Zen works like any other provider in zanecode. You login to zanecode Zen and get
...
:::tip
We tested a select group of models and providers that work well with zanecode.
:::
...
zanecode Zen is an AI gateway that gives you access to these models.

---

## How it works

zanecode Zen works like any other provider in zanecode.

1. You sign in to **<a href={console}>zanecode Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select zanecode Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your zanecode config
...
- DeepSeek V4 Flash Free is available on zanecode for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on zanecode for a limited time. The team is using this time to collect feedback and improve the model.
- North Mini Code Free is available on zanecode for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on zanecode for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on zanecode for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with zanecode as well.
