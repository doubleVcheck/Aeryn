---
title: TUI
description: Arbeite mit zanecode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

zanecode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet zanecode die TUI im aktuellen Verzeichnis.
...
In der zanecode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu zanecode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet zanecode. _Aliase_: `/quit`, `/q`
...
- `leader_timeout` - Steuert, wie lange zanecode nach der leader key wartet. Standard ist `2000`.
