...
description: Erstellen Sie Tools, die der LLM in zanecode aufrufen kann.
---

Benutzerdefinierte Tools sind von Ihnen erstellte Funktionen, die der LLM während Gesprächen aufrufen kann. Sie arbeiten neben [built-in tools](/docs/tools) von zanecode wie `read`, `write` und `bash`.
