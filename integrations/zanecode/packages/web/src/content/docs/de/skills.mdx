...
Agent Skills erlauben zanecode, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
zanecode sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft zanecode vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
zanecode listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
