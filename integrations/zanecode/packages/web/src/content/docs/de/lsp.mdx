---
title: LSP Server
description: zanecode lässt sich in Ihren LSP-Server integrieren.
---

zanecode kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

zanecode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und zanecode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer zanecode-Konfiguration aktivieren und anpassen.
