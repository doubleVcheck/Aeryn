...
Mit zanecode kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet zanecode das `opencode`-Theme.
...
zanecode liefert mehrere eingebaute Themes mit.
...
- zanecode optisch ans Terminal anpassen wollen
...
zanecode unterstuetzt ein flexibles JSON-basiertes Theme-System.
