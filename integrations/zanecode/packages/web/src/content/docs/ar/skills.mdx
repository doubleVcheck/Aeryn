...
تتيح مهارات الوكيل لـ zanecode اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
بالنسبة لمسارات المشروع المحلية، يتدرج zanecode صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض zanecode المهارات المتاحة في وصف أداة `skill`.
