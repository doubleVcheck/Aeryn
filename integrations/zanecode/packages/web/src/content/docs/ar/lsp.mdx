---
title: خوادم LSP
description: يتكامل zanecode مع خوادم LSP لديك.
---

يمكن أن يتكامل zanecode مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي zanecode مع عدة خوادم LSP مدمجة للغات الشائعة:
