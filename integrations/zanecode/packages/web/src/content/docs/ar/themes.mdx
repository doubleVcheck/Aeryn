...
مع zanecode يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم zanecode سمتنا `opencode`.
...
يأتي zanecode مع عدة سمات مدمجة.
...
- يريدون أن يطابق zanecode مظهر terminal لديهم
...
يدعم zanecode نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
