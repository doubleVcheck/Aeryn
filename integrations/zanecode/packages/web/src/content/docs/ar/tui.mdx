---
title: TUI
description: استخدام واجهة المستخدم TUI في zanecode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر zanecode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل zanecode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة zanecode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى zanecode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من zanecode. _الأسماء المستعارة_: `/quit`, `/q`
...
- `leader_timeout` - يتحكم في مدة انتظار zanecode بعد الضغط على leader key. القيمة الافتراضية `2000`.
