...
Vous pouvez ajouter des commandes personnalisées via la configuration zanecode ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre zanecode [config](/docs/config) :
