...
Les compétences d'agent permettent à zanecode de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
zanecode recherche ces emplacements :
...
Pour les chemins locaux du projet, zanecode remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
zanecode répertorie les compétences disponibles dans la description de l'outil `skill`.
