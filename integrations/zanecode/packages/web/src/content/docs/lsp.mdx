---
title: LSP Servers
description: zanecode integrates with your LSP servers.
---

zanecode can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

zanecode comes with several built-in LSP servers for popular languages:
