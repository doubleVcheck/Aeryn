---
title: Deling
description: Del dine zanecode-samtaler.
---

zanecodes delingsfunksjon lar deg lage offentlige lenker til dine zanecode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, zanecode:
...
zanecode støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger zanecode manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
