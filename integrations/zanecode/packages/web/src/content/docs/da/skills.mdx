...
Agentferdigheter lar zanecode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
zanecode søker etter disse stedene:
...
For prosjektlokale stier går zanecode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
zanecode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
