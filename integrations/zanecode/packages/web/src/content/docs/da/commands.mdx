...
Du kan tilføje brugerdefinerede kommandoer gennem zanecode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din zanecode [config](/docs/config):
