...
You can add custom commands through the zanecode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your zanecode [config](/docs/config):
