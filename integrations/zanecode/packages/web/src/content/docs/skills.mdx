...
Agent skills let zanecode discover reusable instructions from your repo or home directory.
...
zanecode searches these locations:
...
For project-local paths, zanecode walks up from your current working directory until it reaches the git worktree.
...
zanecode lists available skills in the `skill` tool description.
