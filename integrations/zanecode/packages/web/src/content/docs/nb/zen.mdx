---
title: Zen
description: Utvalgt liste over modeller levert av zanecode.
---
...
zanecode Zen er en liste over testede og verifiserte modeller levert av zanecode-teamet.

Zen fungerer som enhver annen leverandør i zanecode. Du logger inn på zanecode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med zanecode.
:::
...
zanecode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

zanecode Zen fungerer som enhver annen leverandør i zanecode.

1. Du logger inn på **<a href={console}>zanecode Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger zanecode Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i zanecode-konfigurasjonen din
...
- DeepSeek V4 Flash Free er tilgjengelig på zanecode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på zanecode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på zanecode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på zanecode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på zanecode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet zanecode Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med zanecode også.
