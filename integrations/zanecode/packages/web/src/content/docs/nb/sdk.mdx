---
title: SDK
description: Typesikker JS-klient for zanecode-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

zanecode JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere zanecode programmatisk.
...
Opprett en forekomst av zanecode:
...
Hvis du allerede har en kjørende forekomst av zanecode, kan du opprette en klientforekomst for å koble til den:
