...
zanecode kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

zanecode kommer med flere innebygde LSP-servere for populære språk:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i zanecode-konfigurasjonen.
