---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez zanecode.
---
...
zanecode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół zanecode.

Zen działa jak każdy inny dostawca w zanecode. Logujesz się do zanecode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z zanecode.
:::
...
zanecode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

zanecode Zen działa jak każdy inny dostawca w zanecode.

1. Logujesz się do **<a href={console}>zanecode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz zanecode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji zanecode używa formatu
...
- DeepSeek V4 Flash Free jest dostępny w zanecode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w zanecode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w zanecode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w zanecode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w zanecode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w zanecode także dowolnego innego dostawcy.
