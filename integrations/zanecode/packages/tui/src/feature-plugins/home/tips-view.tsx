...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation when sharing is enabled",
  ...
  "Use the ZaneLLM web UI to add keys, base URLs, and upstream models",
  ...
  "Create a zanecode config file for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in your global zanecode config directory",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "Add markdown command files to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add markdown agent files for specialized AI personas",
  ...
  "Create TypeScript tool files to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add TypeScript plugin files for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent zanecode from reading sensitive files",
  "Use {highlight}zanecode run{/highlight} for non-interactive scripting",
  "Use {highlight}zanecode --continue{/highlight} to resume the last session",
  "Use {highlight}zanecode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}zanecode serve{/highlight} for headless API access to zanecode",
  "Use {highlight}zanecode run --attach{/highlight} to connect to a running server",
  "Run {highlight}zanecode upgrade{/highlight} to update to the latest version",
  "Run {highlight}zanecode auth list{/highlight} to see all configured providers",
  "Run {highlight}zanecode agent create{/highlight} for guided agent creation",
  "Use the GitHub workflow command in issues or PRs to trigger AI actions",
  "Run {highlight}zanecode github install{/highlight} to set up the GitHub workflow",
  "Comment the configured workflow command on issues to auto-create PRs",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in your zanecode theme directory",
  ...
  "Run {highlight}zanecode debug config{/highlight} to troubleshoot configuration",
  ...
  "Run zanecode in a container for isolated projects",
  "Use ZaneLLM for curated, tested upstream models",
