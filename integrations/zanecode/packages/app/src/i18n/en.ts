export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Models provided by ZaneLLM",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in zanecode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "ZaneLLM gives you access to curated, optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "artemisiahub",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in zanecode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in zanecode.",
  ...
  "dialog.plugins.empty": "Plugins configured in zanecode config",
  ...
  "dialog.server.description": "Switch which zanecode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "zanecode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking zanecode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking zanecode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating zanecode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating zanecode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update zanecode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update zanecode",
  "wsl.onboarding.opencodeReadyIn": "zanecode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "zanecode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install zanecode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install zanecode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "zanecode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before zanecode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "zanecode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen zanecode.",
  ...
  "toast.update.description": "A new version of zanecode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the ZaneLLM project",
  ...
  "error.chain.checkConfig": "Check your zanecode config provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, zanecode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "ZaneLLM models are ready once configured in the web UI.",
  ...
  "settings.desktop.wsl.description": "Run the zanecode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for zanecode",
  ...
  "settings.general.row.appearance.description": "Customise how zanecode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether zanecode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how zanecode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when zanecode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of zanecode.",
