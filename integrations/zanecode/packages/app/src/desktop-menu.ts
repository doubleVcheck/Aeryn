...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Zane project", href: "https://github.com/zephyrzane/zanellm" },
      { type: "item", label: "Zane issues", href: "https://github.com/zephyrzane/zanellm/issues" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/zephyrzane/zanellm/issues/new",
      },
      {
        type: "item",
        label: "Report a Bug",
