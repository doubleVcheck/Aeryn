...
import { brandedDisplayName, brandedPathName, sortedRootSessions } from "./helpers"
    ...
    <Show
      ...
      fallback={
        <span class="text-14-medium text-text-base min-w-0 truncate">
          {brandedDisplayName(props.branch()) || brandedPathName(props.directory)}
        </span>
      }
    >
      <props.InlineEditor
...
export const SortableWorkspace = (props: {
  ...
  const workspaceValue = createMemo(() => {
    ...
    const name = brandedDisplayName(branch) || brandedPathName(props.directory)
