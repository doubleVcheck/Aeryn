    ...
    <MenuV2 open={store.open} modal={false} placement="top-start" gutter={6} onOpenChange={setOpen}>
      ...
      <MenuV2.Portal>
        <MenuV2.Content
          ...
          class="w-[min(560px,calc(100vw_-_32px))] overflow-hidden rounded-md border border-v2-border-border-muted bg-v2-background-bg-layer-01 !p-0 shadow-[var(--v2-elevation-floating)] focus:outline-none"
        ...
        >
          ...
          <ScrollView data-slot="model-selector-scroll" class="max-h-[min(520px,calc(100vh_-_180px))] min-h-0">
