...
const en = {
  "app.title": "AI Model Usage Rankings | zanecode Data",
  "app.description":
    "Explore zanecode Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "zanecode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star zanecode on GitHub",
  "header.github": "GitHub",
  "header.tryzanecode": "Try zanecode",
  ...
  "home.topModelsDescription": "Usage of models across zanecode Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique zanecode Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | zanecode Data",
  "lab.description":
    "Compare {{lab}} models used in zanecode Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent zanecode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in zanecode",
  ...
  "lab.shareOfUsage": "{{share}} of recent zanecode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | zanecode Data",
  "model.description":
    "View {{model}} zanecode Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. zanecode Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's zanecode Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's zanecode Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No zanecode Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no zanecode Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily zanecode Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique zanecode Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average zanecode Go session shape.",
  ...
  "model.geoDescription": "zanecode Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No zanecode Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent zanecode Go token volume.",
