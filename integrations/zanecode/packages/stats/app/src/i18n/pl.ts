export const dict = {
  "app.title": "Rankingi użycia modeli AI | zanecode Data",
  "app.description":
    "Przeglądaj użycie zanecode Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny zanecode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę zanecode na GitHub",
  "header.github": "GitHub",
  "header.tryzanecode": "Wypróbuj zanecode",
  ...
  "footer.homeAria": "Strona główna zanecode",
  ...
  "home.topModelsDescription": "Użycie modeli w zanecode Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy zanecode Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | zanecode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w zanecode Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia zanecode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w zanecode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia zanecode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów zanecode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | zanecode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w zanecode Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie zanecode Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu zanecode Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu zanecode Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia zanecode Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny zanecode Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia zanecode Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów zanecode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy zanecode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji zanecode Go.",
  ...
  "model.geoDescription": "Tokeny modelu zanecode Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne zanecode Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów zanecode Go.",
