...
- Secondary audience: zanecode and other durable agent runtimes
...
zanecode and other durable runtimes need to own persistence, tool settlement,
...
zanecode should migrate to `generateTurn` / `streamTurn`, preserving its durable
