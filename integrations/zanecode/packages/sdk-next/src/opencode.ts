import { zanecode } from "@opencode-ai/client/effect"
...
export const create = Effect.fn("zanecode.create")(function* () {
  ...
  const client = yield* zanecode.make({ baseUrl: "http://opencode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@opencode-ai/sdk-next/zanecode") {}
