...
import type { AssistantMessage as zanecodeAssistantMessage, Message } from "@opencode-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<zanecodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<zanecodeAssistantMessage, "role"> &
  Partial<Pick<zanecodeAssistantMessage, "providerID" | "modelID">>
