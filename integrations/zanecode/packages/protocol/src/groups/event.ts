...
export const zanecodeEvent = event.schema
export type zanecodeEvent = typeof zanecodeEvent.Type
export type zanecodeEventEncoded = typeof zanecodeEvent.Encoded
